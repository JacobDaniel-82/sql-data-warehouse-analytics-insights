...
PURPOSE:
    ...
    -- gold.report_customers: Customer-centric behavior & segmentation (RFM).
===============================================================================
*/
-------------------------------------------------------------------------------
...
WITH base_query AS (
    /* 1) Base Query: Link Sales to Customer Metadata */
    SELECT 
        f.order_number,
        f.product_key,
        f.order_date,
...
customer_aggregation AS (
    /* 2) Aggregations: Summarize at Customer Level */
    SELECT 
        customer_key,
        customer_number,
        customer_name,
...
SELECT 
    ...
    customer_name,
    age,
    /* 3) Business Logic: Demographic & Behavioral Segmentation */
    CASE
